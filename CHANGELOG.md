...
### 12. Бодит backend — бараа, захиалга, аналитик (Firestore)
- **Бараа Firestore-д**: `products` коллекц + `/api/products` (нийтийн), `/api/admin/products`
  (CRUD), `/api/admin/seed` (нэг удаагийн seed). Статик жагсаалт нь зөвхөн seed/fallback.
- **Storefront бодит өгөгдлөөр**: нүүр, бараа, дэлгэрэнгүй, хямдрал, сагс, wishlist, checkout
  бүгд Firestore-оос `useProducts` store-оор уншина (статикаар шууд эхэлж, дараа нь шинэчилнэ —
  хоосон харагдахгүй). Админд бараа засвал сайт redeploy-гүйгээр шинэчлэгдэнэ.
- **Админ самбар бүрэн бодит болов**:
  - *Бараа*: нэмэх / устгах / үнэ, нөөц шууд засах (Firestore-д бичигдэнэ).
  - *Захиалга*: бодит захиалга + статусыг dropdown-оор шинэчилнэ.
  - *Самбар (аналитик)*: нийт захиалга, орлого, үйлчлүүлэгч, дундаж — бүгд бодит захиалгаас
    тооцоолно. 7 хоногийн захиалгын график, статусын задаргаа, нөөц багатай бараа.
  - *Үйлчлүүлэгч*: бодит захиалгаас автоматаар гаргана (хуурамч жагсаалт устсан).
- Хуурамч (placeholder) тоонууд бүгд арилж, бодит өгөгдлөөр солигдсон.
```
app/icon.svg
app/apple-icon.svg
